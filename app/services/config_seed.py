...
DEFAULT_SUBCATEGORIES = {
    ...
    "transformer": ["高频变压器", "隔离变压器", "脉冲变压器", "网络变压器", "环形变压器", "音频变压器"],
    "ferrite_bead": ["贴片磁珠", "功率磁珠", "插件磁珠", "高频磁珠"],
    "transistor": ["NPN三极管", "PNP三极管", "达林顿管", "带阻三极管"],
    "fet_igbt": ["N沟道MOSFET", "P沟道MOSFET", "IGBT单管", "IGBT模块", "氮化镓晶体管", "碳化硅晶体管"],
    "diode": ["通用二极管","整流二极管", "稳压二极管", "肖特基二极管", "快恢复二极管", "开关二极管"],
    "protection": ["熔断保险丝", "自恢复保险丝", "TVS瞬态抑制管", "ESD静电保护管", "气体放电管"],
    "ic": ["光电耦合器", "隔离器", "逻辑芯片", "接口芯片", "ADC转换器", "DAC转换器", "电平转换芯片"],
    "power_chip": ["LDO稳压器", "DCDC开关电源", "电压基准芯片","锂电池充电管理", "PMIC电源管理", "锂电保护芯片"],
    "amplifier": ["通用运放", "精密运放", "高速运放", "低功耗运放", "仪表放大器", "功率放大器", "音频放大器"],
    ...
    "cable": ["端子线", "排线", "同轴线", "屏蔽线", "硅胶线", "USB线", "网络线"],
    "battery_cell": ["锂离子电芯", "磷酸铁锂电芯", "聚合物电芯", "镍氢电池", "铅酸电池", "圆柱电芯", "软包电芯", "方形电芯"],
    "electroacoustic_display": ["蜂鸣器", "扬声器", "数码管", "LCD显示屏", "OLED显示屏", "触摸屏"],
    "led": ["贴片单色LED", "RGB发光二极管", "红外发射管", "紫外LED"],
    "pcb": ["裸板", "光板"],
    "pcba": ["半成品板", "成品板"],
}
